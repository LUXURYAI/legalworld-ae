...
import {
  ...
  ChevronRight, FileCheck2, Globe2, Handshake, Languages, Mail, Menu, Phone,
  ShieldCheck, Sparkles, Users, X, MessageCircle
} from 'lucide-react'
import { languages, translations } from './translations'
import './styles.css'

const EMAIL = 'Legalworld579@gmail.com'
const PHONE_DISPLAY = '+971 58 659 7393'
const PHONE_LINK = '+971586597393'
const WHATSAPP_LINK = 'https://wa.me/971586597393?text=Hello%20Legal%20World%2C%20I%20would%20like%20to%20receive%20a%20consultation.'
  ...
  return (
    <>
          ...
          <div className="container contact-grid">
            <Reveal>
              ...
              <div className="contact-links">
                ...
                <a className="email-link" href={`tel:${PHONE_LINK}`}>
                  <Phone size={19} /> {PHONE_DISPLAY}
                </a>
                <a
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Contact Legal World on WhatsApp"
        title="WhatsApp"
      >
        ...
        <div className="container footer-grid">
          <div className="footer-brand">
            ...
            <div>
              ...
              <a className="footer-phone" href={`tel:${PHONE_LINK}`}>{PHONE_DISPLAY}</a>
            </div>
          </div>
